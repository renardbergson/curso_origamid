...
function mostrarTipoRetorno2(a) {
    return a;
}
...
mostrarTipoRetorno2("sou uma string").toUpperCase();
mostrarTipoRetorno2(200);
mostrarTipoRetorno2(true);
/*
  Como funciona?
