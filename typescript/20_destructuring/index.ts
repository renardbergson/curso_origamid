...
function handleData({ nome, preco }: { nome: string; preco: number }): void {
...
// ========== EXEMPLO 2.1 ==========
// Utilizando uma Interface para definir o tipo, facilitando a reutilização e clareza.
interface Data {
  nome: string;
  preco?: number; // Preço é opcional
}

function handleData2({ nome, preco }: Data): void {
  console.log(
    `Produto: ${nome.toLocaleLowerCase()}, Preço: ${preco?.toLocaleString(
      "pt-BR",
      {
        style: "currency",
        currency: "BRL",
