...
// O tipo "undefined" será bem comum quando trabalharmos com objetos que possuirem propriedades opcionais
// Quando opcionais, essas propriedades poderão sempre retornar um valor definido ou "undefined"
interface Produto {
  nome?: string; // propriedade opcional
}
